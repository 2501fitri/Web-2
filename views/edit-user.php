        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <from action="edit-user.php?id=<?= $user['id'] ?>" method="POST">
                            <div class="mb-3">
                                <label for="firstname" class="form-label">First Name</label>
                                <input type="text" class="from-control" id="firstname" name="firstname" value="<?= $user['firstname'] ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="lastname" class="form-label">Last Name</label>
                                <input type="text" class="from-control" id="lastname" name="lastname" value="<?= $user['lastname'] ?>" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="from-control" id="age" name="age" min="0" max="100" value="<?= $user['age'] ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="weight" class="form-label">Weight</label>
                                <input type="text" class="from-control" id="weight" name="weight" min="0" max="100" value="<?= $user['weight'] ?>" required>
                            </div>
