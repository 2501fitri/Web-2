        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <from action="create-user.php" method="POST">
                            <div class="mb-3">
                                <label for="firstname" class="form-label">First Name</label>
                                <input type="text" class="from-control" id="firstname" name="firstname" required>
                            </div>
                            <div class="mb-3">
                                <label for="lastname" class="form-label">Last Name</label>
                                <input type="text" class="from-control" id="lastname" name="lastname" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="from-control" id="age" name="age" min="0" max="100" required>
                            </div>
                            <div class="mb-3">
                                <label for="weight" class="form-label">Weight</label>
                                <input type="text" class="from-control" id="weight" name="weight" min="0" max="100" required>
                            </div>
